...
var Child = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div>This is Child!</div>`;
});
var index_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => 'p.svelte-ynw52d{color:purple;font-family:"Comic Sans MS", cursive;font-size:2em}')();
var css = {
  code: 'p.svelte-ynw52d{color:purple;font-family:"Comic Sans MS", cursive;font-size:2em}',
  map: null
};
var Pages = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>This is svelte!</title>`, ""}`, ""}
<p class="${"svelte-ynw52d"}">This is Kvelte! ${escape(message)}</p>

<button>Clicked ${escape(count)}
  ${escape("times")}</button>
<img src="${"/assets/svelte.png"}" alt="${"Svelte logo"}">
${validate_component(Child, "Child").$$render($$result, {}, {}, {})}
<div>message is ${escape((0, import_lodash.isString)(message))}</div>`;
});
